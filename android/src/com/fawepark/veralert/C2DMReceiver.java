...
static public void FireAndForgetUrl(String url_string, Map<String,String> dict) {
    ...
    public void onRegistrered(Context context, String registrationId) throws IOException {
    	...
    	dict.put("id_a", main.getIDStringA(this));
    ...
    void dumpPrefs()
    {
      	SharedPreferences p = PreferenceManager.getDefaultSharedPreferences(this);
       	...
       	for (Object iterable_element : m.keySet()) {
       		Log.d(TAG, iterable_element + " = " + m.get(iterable_element));
		}
     ...
     void AlertIndicator(Context context, String msg){
    	 ...
    	 String match_string = "AlertTone";
      	...
      	SharedPreferences p = PreferenceManager.getDefaultSharedPreferences(this);
       	...
       	String pref_string = "ringtonePref" + atn;
       	
       	Log.i(TAG,"Searching for :" + pref_string);
       	
       	String rt = p.getString(pref_string, "");
       	
       	Log.i(TAG,"using ringtone : "+ rt);
